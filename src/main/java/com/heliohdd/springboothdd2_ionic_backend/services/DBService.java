...
import com.heliohdd.springboothdd2_ionic_backend.domain.PagamentoComBoleto;
...
import com.heliohdd.springboothdd2_ionic_backend.repositories.EnderecoRepository;
import com.heliohdd.springboothdd2_ionic_backend.repositories.EstadoRepository;
import com.heliohdd.springboothdd2_ionic_backend.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "heliohdd@yahoo.com.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "testemailspringboot@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
